...
describe('testConfig function testing', function(){
  ...
  describe('#getConfig()', function(){
    ...
    it('should contain all the default testParameters', function(done){
      var testParameters = [
        'afterLaunchLogin', 'app', 'baseHost', 'beforeLaunchLogin', 'environment', 'generateHTMLReport', 'globalTimeout',
        'locale', 'location', 'loginUserKeyMap', 'loginUsers', 'maxThreads', 'proxyUrl', 'runInParallel', 'sauceKey',
        'sauceUser', 'suites', 'testFilter', 'username', 'waitTimeout'
      ];
